    ...
    <div className='px-10 md:px-28 lg:px-48 xl:px-64 mt-8 '>
        <div className='flex flex-col items-center justify-center border rounded-lg bg-white p-7 mb-20 lg:px-33 xl:px-52'>
            ...
            <div className='w-full mt-3'> 
                ...
                <Input className='mt-3' placeholder='e.g. Rohit Singh' onChange={(event)=>setUserName(event.target.value)} />
            </div>
            <div className='w-full mt-3'> 
                <h2>Enter your Email</h2>
                <Input className='mt-3' placeholder='e.g. rohit@gmail.com' onChange={(event)=>setUserEmail(event.target.value)} />
            </div>
            ...
            <div>
                ...
                <ul className=''>
                    <li className='test-sm text-primary'>-Ensure you have a stable internet connection</li>
                    <li className='test-sm text-primary'>-Test your camera and microphone</li>
                    <li className='test-sm text-primary'>-Find Quiet place for interview</li>
                </ul>
            </div>
            </div>
            <Button className={'mt-5 w-full font-bold'}
                disabled={loading||!userName}
                onClick={()=>onJionInterview()}
            >
